...
import { NAV_LINKS, PHONE, PHONE_LINK, WHATSAPP_LINK } from '../data/constants'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a
              href={`tel:+${PHONE_LINK}`}
              className="flex items-center gap-2 text-sm font-semibold text-navy-800 hover:text-lime-600 transition-colors"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-lime-500 hover:bg-lime-600 text-white font-semibold text-sm px-5 py-2.5 rounded-full transition-colors"
            >
